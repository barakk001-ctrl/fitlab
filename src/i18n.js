...
const STRINGS = {
  en: {
    ...
    open_timer: 'Rest timer',
    find_swap: 'Find a substitute',
    swap_title: "Can't do it? Swap it.",
    swap_sub: "Pick the exercise you can't do — and get every alternative that trains the same movement pattern.",
    swap_pick_label: "Which exercise can't you do?",
    swap_where: 'Where are you training?',
    swap_gym: 'Gym',
    swap_home: 'Bodyweight / Home',
    swap_any: 'Anywhere',
    swap_alts: '{n} alternatives · same movement pattern',
    swap_none: 'No alternatives in this setting — try the other one.',
    ws_swap_title: 'Swap this exercise',
    ws_swap_note: 'Same movement pattern — your sets & reps stay.',
    mode_physio: 'Physio',
    physio_title: 'The recovery room.',
    physio_sub: 'Short physiotherapy-style sessions for the joint that nags. Slow tempo, pain-free range, a few minutes a day.',
    physio_pick: 'Choose an area',
    physio_disclaimer: 'Gentle mobility & strengthening — not medical advice. Sharp pain, numbness or swelling? See a professional first.',
    physio_back: 'All areas',
    physio_start: 'Start guided session',
    physio_moves: '{n} exercises',
    physio_min: '~{m} min',
    physio_per_side: 'per side',
    physio_rounds: 'Rounds',
    physio_rounds_hint: 'One round is a light daily dose — physios usually prescribe 2–3 sets, so 2–3 rounds match the standard.',
    guided_move_of: 'Exercise {i} of {n}',
    physio_reminder: 'Daily reminder',
    physio_reminder_sub: 'A push notification every day at this hour — a nudge to do your few minutes.',
    reminder_enable: 'Enable',
    reminder_active: 'Daily at {t}',
    reminder_disable: 'Turn off',
    notif_run_again: 'Run again',
    notif_rest_running: 'Rest running — {s}s',
    notif_physio_title: 'Physio time',
    notif_physio_body: 'A few gentle minutes for the joint that nags.',
  ...
  he: {
    ...
    open_timer: 'טיימר מנוחה',
    find_swap: 'תרגיל חלופי',
    swap_title: 'לא מסתדר? מחליפים.',
    swap_sub: 'בחרו את התרגיל שלא מתאפשר — וקבלו כל חלופה שמאמנת את אותה תבנית תנועה.',
    swap_pick_label: 'איזה תרגיל לא מתאפשר?',
    swap_where: 'איפה מתאמנים?',
    swap_gym: 'חדר כושר',
    swap_home: 'משקל גוף / בית',
    swap_any: 'בכל מקום',
    swap_alts: '{n} חלופות · אותה תבנית תנועה',
    swap_none: 'אין חלופות במסגרת הזו — נסו את האחרת.',
    ws_swap_title: 'החלפת התרגיל',
    ws_swap_note: 'אותה תבנית תנועה — הסטים והחזרות נשמרים.',
    mode_physio: 'פיזיו',
    physio_title: 'חדר ההחלמה.',
    physio_sub: 'מפגשים קצרים בסגנון פיזיותרפיה למפרק שמציק. קצב איטי, טווח ללא כאב, כמה דקות ביום.',
    physio_pick: 'בחרו אזור',
    physio_disclaimer: 'תרגול עדין לניידות וחיזוק — לא ייעוץ רפואי. כאב חד, נימול או נפיחות? פנו קודם לאיש מקצוע.',
    physio_back: 'כל האזורים',
    physio_start: 'התחלת מפגש מודרך',
    physio_moves: '{n} תרגילים',
    physio_min: '~{m} דק׳',
    physio_per_side: 'לכל צד',
    physio_rounds: 'סבבים',
    physio_rounds_hint: 'סבב אחד הוא מנה יומית קלה — פיזיותרפיסטים ממליצים בדרך כלל על 2–3 סטים, אז 2–3 סבבים תואמים את הסטנדרט.',
    guided_move_of: 'תרגיל {i} מתוך {n}',
    physio_reminder: 'תזכורת יומית',
    physio_reminder_sub: 'התראה כל יום בשעה הזו — דחיפה עדינה לעשות את הדקות שלכם.',
    reminder_enable: 'הפעלה',
    reminder_active: 'כל יום ב־{t}',
    reminder_disable: 'כיבוי',
    notif_run_again: 'עוד סבב',
    notif_rest_running: 'מנוחה רצה — {s} שנ׳',
    notif_physio_title: 'זמן פיזיו',
    notif_physio_body: 'כמה דקות עדינות למפרק שמציק.',
